...
- Daily Review: Help the user debrief using '${exactPath}'. Read the Philosopher's fleeting notes from the day.
- Template Checking: Before doing anything else, confirm the journal '${exactPath}' exists. If not, explicitly tell the user you are creating it using the template from '${templatePath}'. Use readNote on the template and writeNote on the daily journal.
